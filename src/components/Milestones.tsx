...
const milestones = [
  {
    ...
    description: 'Developed a model for detecting and storing discarded coconuts shells for future use',
    icon: Award
  },
  {
    year: '2024',
            ...
            {milestones.map((milestone, index) => (
              ...
              >
                <div className={`flex-1 ${index % 2 === 0 ? 'md:pr-12' : 'md:pl-12'}`}>
                  <div className="card p-8 bg-gray-800 rounded-xl">
                ...
                <div className="absolute left-1/2 transform -translate-x-1/2 w-8 h-8 bg-blue-500 rounded-full border-4 border-black"></div>
              </div>
            ))}
          </div>
        </div>
